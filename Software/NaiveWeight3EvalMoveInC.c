#include "NaiveWeight3EvalMoveInC.h"
#include <limits.h>
int getNaiveWeight3EvalColumn_4x4(Board_4x4* board, Discs playerDisc)
{
	int score;
	int bestScore;
	...
	for (int col = 0; col < WIDTH_4x4; col++)
	{
		...
		score = weight3Eval_4x4(&tempBoard);
		if (playerDisc == PLAYER_ONE_DISC)
		{
			if (score > bestScore) {
				bestScore = score;
...
int getNaiveWeight3EvalColumn_7x4(Board_7x4* board, Discs playerDisc)
{
	int score;
	int bestScore;
	if (playerDisc == PLAYER_ONE_DISC)
	...
	for (int col = 0; col < WIDTH_7x4; col++)
	{
		...
		score = weight3Eval_7x4(&tempBoard);
		if (playerDisc == PLAYER_ONE_DISC)
		{
			if (score > bestScore) {
				bestScore = score;
...
int getNaiveWeight3EvalColumn_4x7(Board_4x7* board, Discs playerDisc)
{
	int score;
	int bestScore;
	if (playerDisc == PLAYER_ONE_DISC)
	...
	for (int col = 0; col < WIDTH_4x7; col++)
	{
		...
		score = weight3Eval_4x7(&tempBoard);
		if (playerDisc == PLAYER_ONE_DISC)
		{
			if (score > bestScore) {
				bestScore = score;
...
int getNaiveWeight3EvalColumn_7x6(Board_7x6* board, Discs playerDisc)
{
	int score;
	int bestScore;
	if (playerDisc == PLAYER_ONE_DISC)
	...
	for (int col = 0; col < WIDTH_7x6; col++)
	{
		...
		score = weight3Eval_7x6(&tempBoard);
		if (playerDisc == PLAYER_ONE_DISC)
		{
			if (score > bestScore) {
				bestScore = score;
...
int getNaiveWeight3EvalColumn_6x7(Board_6x7* board, Discs playerDisc)
{
	int score;
	int bestScore;
	if (playerDisc == PLAYER_ONE_DISC)
	...
	for (int col = 0; col < WIDTH_6x7; col++)
	{
		...
		score = weight3Eval_6x7(&tempBoard);
		if (playerDisc == PLAYER_ONE_DISC)
		{
			if (score > bestScore) {
				bestScore = score;
...
int getNaiveWeight3EvalColumn_8x8(Board_8x8* board, Discs playerDisc)
{
	int score;
	int bestScore;
	if (playerDisc == PLAYER_ONE_DISC)
	...
	for (int col = 0; col < WIDTH_8x8; col++)
	{
		...
		score = weight3Eval_8x8(&tempBoard);
		if (playerDisc == PLAYER_ONE_DISC)
		{
			if (score > bestScore) {
				bestScore = score;
...
int getNaiveWeight3EvalColumn_14x12(Board_14x12* board, Discs playerDisc)
{
	int score;
	int bestScore;
	if (playerDisc == PLAYER_ONE_DISC)
	...
	for (int col = 0; col < WIDTH_14x12; col++)
	{
		...
		score = weight3Eval_14x12(&tempBoard);
		if (playerDisc == PLAYER_ONE_DISC)
		{
			if (score > bestScore) {
				bestScore = score;
...
int getNaiveWeight3EvalColumn_12x14(Board_12x14* board, Discs playerDisc)
{
	int score;
	int bestScore;
	if (playerDisc == PLAYER_ONE_DISC)
	...
	for (int col = 0; col < WIDTH_12x14; col++)
	{
		...
		score = weight3Eval_12x14(&tempBoard);
		if (playerDisc == PLAYER_ONE_DISC)
		{
			if (score > bestScore) {
				bestScore = score;
