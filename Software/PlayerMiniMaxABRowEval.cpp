...
int PlayerMiniMaxABRowEval::calcEvaluation(Board_4x4* board)
{
	eval = rowEval_4x4(board);
	return eval;
}

int PlayerMiniMaxABRowEval::calcEvaluation(Board_7x6* board)
{
	eval = rowEval_7x6(board);
	return eval;
}

int PlayerMiniMaxABRowEval::calcEvaluation(Board_14x12* board)
{
