...
PlayerMiniMaxABWeight1EvalDepth10::PlayerMiniMaxABWeight1EvalDepth10(GameDataRef data, Discs playerDisc) : _data{ data }, _playerDisc{ playerDisc }
{

}

void PlayerMiniMaxABWeight1EvalDepth10::nextMove(Board_4x4* board, sf::Sprite boardPieces[HEIGHT_4x4][WIDTH_4x4])
{
	int colPlacement;
	int depth = 10;
	int eval;
...
void PlayerMiniMaxABWeight1EvalDepth10::nextMove(Board_7x4* board, sf::Sprite boardPieces[HEIGHT_7x4][WIDTH_7x4])
{
	int colPlacement;
	int depth = 10;
	int eval;
...
void PlayerMiniMaxABWeight1EvalDepth10::nextMove(Board_4x7* board, sf::Sprite boardPieces[HEIGHT_4x7][WIDTH_4x7])
{
	int colPlacement;
	int depth = 10;
	int eval;
...
void PlayerMiniMaxABWeight1EvalDepth10::nextMove(Board_7x6* board, sf::Sprite boardPieces[HEIGHT_7x6][WIDTH_7x6])
{
	int colPlacement;
	int depth = 10;
	int eval;
...
void PlayerMiniMaxABWeight1EvalDepth10::nextMove(Board_6x7* board, sf::Sprite boardPieces[HEIGHT_6x7][WIDTH_6x7])
{
	int colPlacement;
	int depth = 10;
	int eval;
...
void PlayerMiniMaxABWeight1EvalDepth10::nextMove(Board_8x8* board, sf::Sprite boardPieces[HEIGHT_8x8][WIDTH_8x8])
{
	int colPlacement;
	int depth = 10;
	int eval;
...
void PlayerMiniMaxABWeight1EvalDepth10::nextMove(Board_14x12* board, sf::Sprite boardPieces[HEIGHT_14x12][WIDTH_14x12])
{
	int colPlacement;
	int depth = 10;
	int eval;
...
void PlayerMiniMaxABWeight1EvalDepth10::nextMove(Board_12x14* board, sf::Sprite boardPieces[HEIGHT_12x14][WIDTH_12x14])
{
	int colPlacement;
	int depth = 10;
	int eval;
...
void PlayerMiniMaxABWeight1EvalDepth10::updateGameState(Board_4x4* board, sf::Sprite boardPieces[HEIGHT_4x4][WIDTH_4x4])
{

}

void PlayerMiniMaxABWeight1EvalDepth10::updateGameState(Board_7x6* board, sf::Sprite boardPieces[HEIGHT_7x6][WIDTH_7x6])
{

}

void PlayerMiniMaxABWeight1EvalDepth10::updateGameState(Board_14x12* board, sf::Sprite boardPieces[HEIGHT_14x12][WIDTH_14x12])
{
