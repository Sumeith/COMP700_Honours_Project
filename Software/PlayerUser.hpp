...
public:
	...
	int calcEvaluation(Board_7x4* board);
	int calcEvaluation(Board_4x7* board);
	int calcEvaluation(Board_7x6* board);
	int calcEvaluation(Board_6x7* board);
	int calcEvaluation(Board_8x8* board);
	int calcEvaluation(Board_14x12* board);
	int calcEvaluation(Board_12x14* board);
