...
PlayerMiniMaxABWeight1Eval::PlayerMiniMaxABWeight1Eval(GameDataRef data, Discs playerDisc) : _data{ data }, _playerDisc{ playerDisc }
{

}

void PlayerMiniMaxABWeight1Eval::nextMove(Board_4x4* board, sf::Sprite boardPieces[HEIGHT_4x4][WIDTH_4x4])
{
	int colPlacement;
	int depth = INT_MAX;
	int eval;
...
void PlayerMiniMaxABWeight1Eval::nextMove(Board_7x4* board, sf::Sprite boardPieces[HEIGHT_7x4][WIDTH_7x4])
{
	int colPlacement;
	int depth = INT_MAX;
	int eval;
...
void PlayerMiniMaxABWeight1Eval::nextMove(Board_4x7* board, sf::Sprite boardPieces[HEIGHT_4x7][WIDTH_4x7])
{
	int colPlacement;
	int depth = INT_MAX;
	int eval;
...
void PlayerMiniMaxABWeight1Eval::nextMove(Board_7x6* board, sf::Sprite boardPieces[HEIGHT_7x6][WIDTH_7x6])
{
	int colPlacement;
	int depth = INT_MAX;
	int eval;
...
void PlayerMiniMaxABWeight1Eval::nextMove(Board_6x7* board, sf::Sprite boardPieces[HEIGHT_6x7][WIDTH_6x7])
{
	int colPlacement;
	int depth = INT_MAX;
	int eval;
...
void PlayerMiniMaxABWeight1Eval::nextMove(Board_8x8* board, sf::Sprite boardPieces[HEIGHT_8x8][WIDTH_8x8])
{
	int colPlacement;
	int depth = INT_MAX;
	int eval;
...
void PlayerMiniMaxABWeight1Eval::nextMove(Board_14x12* board, sf::Sprite boardPieces[HEIGHT_14x12][WIDTH_14x12])
{
	int colPlacement;
	int depth = INT_MAX;
	int eval;
...
void PlayerMiniMaxABWeight1Eval::nextMove(Board_12x14* board, sf::Sprite boardPieces[HEIGHT_12x14][WIDTH_12x14])
{
	int colPlacement;
	int depth = INT_MAX;
	int eval;
...
void PlayerMiniMaxABWeight1Eval::updateGameState(Board_4x4* board, sf::Sprite boardPieces[HEIGHT_4x4][WIDTH_4x4])
{

}

void PlayerMiniMaxABWeight1Eval::updateGameState(Board_7x6* board, sf::Sprite boardPieces[HEIGHT_7x6][WIDTH_7x6])
{

}

void PlayerMiniMaxABWeight1Eval::updateGameState(Board_14x12* board, sf::Sprite boardPieces[HEIGHT_14x12][WIDTH_14x12])
{
