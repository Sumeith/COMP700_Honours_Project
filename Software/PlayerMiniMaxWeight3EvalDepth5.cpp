...
PlayerMiniMaxWeight3EvalDepth5::PlayerMiniMaxWeight3EvalDepth5(GameDataRef data, Discs playerDisc) : _data{ data }, _playerDisc{ playerDisc }
{
	playerName = "PlayerMiniMaxWeight3EvalDepth5";
}

void PlayerMiniMaxWeight3EvalDepth5::nextMove(Board_4x4* board, sf::Sprite boardPieces[HEIGHT_4x4][WIDTH_4x4])
{
	...
	minimaxWeight3Eval_4x4(board, depth, _playerDisc, &colPlacement, &eval);
...
void PlayerMiniMaxWeight3EvalDepth5::nextMove(Board_7x4* board, sf::Sprite boardPieces[HEIGHT_7x4][WIDTH_7x4])
{
	...
	int eval;
	auto start = std::chrono::high_resolution_clock::now();
	minimaxWeight3Eval_7x4(board, depth, _playerDisc, &colPlacement, &eval);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerMiniMaxWeight3EvalDepth5::nextMove(Board_4x7* board, sf::Sprite boardPieces[HEIGHT_4x7][WIDTH_4x7])
{
	...
	int eval;
	auto start = std::chrono::high_resolution_clock::now();
	minimaxWeight3Eval_4x7(board, depth, _playerDisc, &colPlacement, &eval);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerMiniMaxWeight3EvalDepth5::nextMove(Board_7x6* board, sf::Sprite boardPieces[HEIGHT_7x6][WIDTH_7x6])
{
	...
	int eval;
	auto start = std::chrono::high_resolution_clock::now();
	minimaxWeight3Eval_7x6(board, depth, _playerDisc, &colPlacement, &eval);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerMiniMaxWeight3EvalDepth5::nextMove(Board_6x7* board, sf::Sprite boardPieces[HEIGHT_6x7][WIDTH_6x7])
{
	...
	int eval;
	auto start = std::chrono::high_resolution_clock::now();
	minimaxWeight3Eval_6x7(board, depth, _playerDisc, &colPlacement, &eval);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerMiniMaxWeight3EvalDepth5::nextMove(Board_8x8* board, sf::Sprite boardPieces[HEIGHT_8x8][WIDTH_8x8])
{
	...
	int eval;
	auto start = std::chrono::high_resolution_clock::now();
	minimaxWeight3Eval_8x8(board, depth, _playerDisc, &colPlacement, &eval);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerMiniMaxWeight3EvalDepth5::nextMove(Board_14x12* board, sf::Sprite boardPieces[HEIGHT_14x12][WIDTH_14x12])
{
	...
	int eval;
	auto start = std::chrono::high_resolution_clock::now();
	minimaxWeight3Eval_14x12(board, depth, _playerDisc, &colPlacement, &eval);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerMiniMaxWeight3EvalDepth5::nextMove(Board_12x14* board, sf::Sprite boardPieces[HEIGHT_12x14][WIDTH_12x14])
{
	...
	int eval;
	auto start = std::chrono::high_resolution_clock::now();
	minimaxWeight3Eval_12x14(board, depth, _playerDisc, &colPlacement, &eval);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerMiniMaxWeight3EvalDepth5::updateGameState(Board_4x4* board, sf::Sprite boardPieces[HEIGHT_4x4][WIDTH_4x4])
{

}

void PlayerMiniMaxWeight3EvalDepth5::updateGameState(Board_7x6* board, sf::Sprite boardPieces[HEIGHT_7x6][WIDTH_7x6])
{

}

void PlayerMiniMaxWeight3EvalDepth5::updateGameState(Board_14x12* board, sf::Sprite boardPieces[HEIGHT_14x12][WIDTH_14x12])
{
