...
PlayerNaiveWeight2Eval::PlayerNaiveWeight2Eval(GameDataRef data, Discs playerDisc) : _data{ data }, _playerDisc{ playerDisc }
{
	playerName = "PlayerNaiveWeight2Eval";
}

void PlayerNaiveWeight2Eval::nextMove(Board_4x4* board, sf::Sprite boardPieces[HEIGHT_4x4][WIDTH_4x4])
{
	...
	int colPlacement = getNaiveWeight2EvalColumn_4x4(board, _playerDisc); 
...
void PlayerNaiveWeight2Eval::nextMove(Board_7x4* board, sf::Sprite boardPieces[HEIGHT_7x4][WIDTH_7x4])
{
	...
	auto start = std::chrono::high_resolution_clock::now();
	int colPlacement = getNaiveWeight2EvalColumn_7x4(board, _playerDisc);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerNaiveWeight2Eval::nextMove(Board_4x7* board, sf::Sprite boardPieces[HEIGHT_4x7][WIDTH_4x7])
{
	...
	auto start = std::chrono::high_resolution_clock::now();
	int colPlacement = getNaiveWeight2EvalColumn_4x7(board, _playerDisc);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerNaiveWeight2Eval::nextMove(Board_7x6* board, sf::Sprite boardPieces[HEIGHT_7x6][WIDTH_7x6])
{
	...
	auto start = std::chrono::high_resolution_clock::now();
	int colPlacement = getNaiveWeight2EvalColumn_7x6(board, _playerDisc);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerNaiveWeight2Eval::nextMove(Board_6x7* board, sf::Sprite boardPieces[HEIGHT_6x7][WIDTH_6x7])
{
	...
	auto start = std::chrono::high_resolution_clock::now();
	int colPlacement = getNaiveWeight2EvalColumn_6x7(board, _playerDisc);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerNaiveWeight2Eval::nextMove(Board_8x8* board, sf::Sprite boardPieces[HEIGHT_8x8][WIDTH_8x8])
{
	...
	auto start = std::chrono::high_resolution_clock::now();
	int colPlacement = getNaiveWeight2EvalColumn_8x8(board, _playerDisc);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerNaiveWeight2Eval::nextMove(Board_14x12* board, sf::Sprite boardPieces[HEIGHT_14x12][WIDTH_14x12])
{
	...
	auto start = std::chrono::high_resolution_clock::now();
	int colPlacement = getNaiveWeight2EvalColumn_14x12(board, _playerDisc);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
void PlayerNaiveWeight2Eval::nextMove(Board_12x14* board, sf::Sprite boardPieces[HEIGHT_12x14][WIDTH_12x14])
{
	...
	auto start = std::chrono::high_resolution_clock::now();
	int colPlacement = getNaiveWeight2EvalColumn_12x14(board, _playerDisc);
	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start);
	timeVector.push_back(duration.count()); if (firstColumn < 0){firstColumn = colPlacement;}
...
//int PlayerNaiveWeight2Eval::calcEvaluation(Board_4x4* board)
//{
//	eval = rowEval_4x4(board);
//	return eval;
//}
//
//int PlayerNaiveWeight2Eval::calcEvaluation(Board_7x6* board)
//{
//	eval = rowEval_7x6(board);
//	return eval;
//}
//
//int PlayerNaiveWeight2Eval::calcEvaluation(Board_14x12* board)
//{
//	eval = rowEval_14x12(board);
//	return eval;
//}

void PlayerNaiveWeight2Eval::updateGameState(Board_4x4* board, sf::Sprite boardPieces[HEIGHT_4x4][WIDTH_4x4])
{

}

void PlayerNaiveWeight2Eval::updateGameState(Board_7x6* board, sf::Sprite boardPieces[HEIGHT_7x6][WIDTH_7x6])
{

}

void PlayerNaiveWeight2Eval::updateGameState(Board_14x12* board, sf::Sprite boardPieces[HEIGHT_14x12][WIDTH_14x12])
{
