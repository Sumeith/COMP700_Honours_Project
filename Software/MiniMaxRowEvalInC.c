...
void minimaxRowEval_7x4(Board_7x4* board, int depth, Discs playerDisc, int* move, int* eval)
{
	...
	for (int col = 0; col < WIDTH_7x4; col++)
	{
		...
		if (playerDisc == PLAYER_ONE_DISC)
		{
			...
			minimaxRowEval_7x4(&tempBoard, depth - 1, PLAYER_TWO_DISC, &tempMove, &tempEval);
			if (tempEval > bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
		...
		else if (playerDisc == PLAYER_TWO_DISC)
		{
			...
			minimaxRowEval_7x4(&tempBoard, depth - 1, PLAYER_ONE_DISC, &tempMove, &tempEval);
			if (tempEval < bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
...
void minimaxRowEval_4x7(Board_4x7* board, int depth, Discs playerDisc, int* move, int* eval)
{
	...
	for (int col = 0; col < WIDTH_4x7; col++)
	{
		...
		if (playerDisc == PLAYER_ONE_DISC)
		{
			...
			minimaxRowEval_4x7(&tempBoard, depth - 1, PLAYER_TWO_DISC, &tempMove, &tempEval);
			if (tempEval > bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
		...
		else if (playerDisc == PLAYER_TWO_DISC)
		{
			...
			minimaxRowEval_4x7(&tempBoard, depth - 1, PLAYER_ONE_DISC, &tempMove, &tempEval);
			if (tempEval < bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
...
void minimaxRowEval_6x7(Board_6x7* board, int depth, Discs playerDisc, int* move, int* eval)
{
	...
	for (int col = 0; col < WIDTH_6x7; col++)
	{
		...
		if (playerDisc == PLAYER_ONE_DISC)
		{
			...
			minimaxRowEval_6x7(&tempBoard, depth - 1, PLAYER_TWO_DISC, &tempMove, &tempEval);
			if (tempEval > bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
		...
		else if (playerDisc == PLAYER_TWO_DISC)
		{
			...
			minimaxRowEval_6x7(&tempBoard, depth - 1, PLAYER_ONE_DISC, &tempMove, &tempEval);
			if (tempEval < bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
...
void minimaxRowEval_8x8(Board_8x8* board, int depth, Discs playerDisc, int* move, int* eval)
{
	...
	for (int col = 0; col < WIDTH_8x8; col++)
	{
		...
		if (playerDisc == PLAYER_ONE_DISC)
		{
			...
			minimaxRowEval_8x8(&tempBoard, depth - 1, PLAYER_TWO_DISC, &tempMove, &tempEval);
			if (tempEval > bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
		...
		else if (playerDisc == PLAYER_TWO_DISC)
		{
			...
			minimaxRowEval_8x8(&tempBoard, depth - 1, PLAYER_ONE_DISC, &tempMove, &tempEval);
			if (tempEval < bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
...
void minimaxRowEval_12x14(Board_12x14* board, int depth, Discs playerDisc, int* move, int* eval)
{
	...
	for (int col = 0; col < WIDTH_12x14; col++)
	{
		...
		if (playerDisc == PLAYER_ONE_DISC)
		{
			...
			minimaxRowEval_12x14(&tempBoard, depth - 1, PLAYER_TWO_DISC, &tempMove, &tempEval);
			if (tempEval > bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
		...
		else if (playerDisc == PLAYER_TWO_DISC)
		{
			...
			minimaxRowEval_12x14(&tempBoard, depth - 1, PLAYER_ONE_DISC, &tempMove, &tempEval);
			if (tempEval < bestEval)
			{
				bestMove = col;
				bestEval = tempEval;
